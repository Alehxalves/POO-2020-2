        ...
        while(true){
            ...
            try {
                if(ui[0].equals("end")){
                    ...
                    whatsapp.createChatGroup(ui[1], ui[2]);
                }else if(ui[0].equals("newTalk")){
                    whatsapp.createChatTalk(ui[1], ui[2]);
                ...
                }else if(ui[0].equals("showHistory")){
                    System.out.println(whatsapp.getHistory(ui[1], ui[2]));
                }else
